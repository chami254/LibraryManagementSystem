...
<body>
    <div class="container">
        <div class="header">
            <h1>Add New Book</h1>
            <p>Fill in the details below to add a new book to the library inventory</p>
        </div>
        ...
        <form id="addBookForm" method="POST" action="<%= request.getContextPath() %>/admin/add-book-action" onsubmit="return validateForm(event)">
            ...
            <div class="form-group">
                ...
                <input type="text" id="title" name="title" placeholder="Enter book title" required maxlength="200">
                <div class="character-count"><span id="titleCount">0</span>/200</div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="author" name="author" placeholder="Enter author name" required maxlength="100">
                    <div class="character-count"><span id="authorCount">0</span>/100</div>
                </div>

                <div class="form-group">
                    <label for="isbn">ISBN</label>
                    <input type="text" id="isbn" name="isbn" placeholder="Enter ISBN (10-20 chars)" maxlength="20">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="quantity" name="quantity" placeholder="Enter quantity" required min="1" max="9999" value="1">
            ...
            <div class="loading" id="loadingSpinner">
                ...
                <p>Adding book, please wait...</p>
            </div>

            <div class="button-group">
                <button type="submit" class="btn-submit" id="submitBtn">Add Book</button>
